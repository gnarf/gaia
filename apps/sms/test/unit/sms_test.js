...
suite('SMS App Unit-Test', function() {
  ...
  // DISABLED -- Needs to be updated for multirecipient support

  //  - DO NOT USE PHONE NUMBER AS THREAD IDENTITY
  ...
  //   test('Sending to short nr should not link to contact', function() {
