...
var ThreadUI = global.ThreadUI = {
  ...
  init: function thui_init() {
    ...
    var templateIds = ['contact', 'highlight', 'recipient'];
  ...
  messageComposerFocusHandler: function thui_messageInputHandler(event) {
    ...
    // Restore the the outer view height (could be open)
    this.toField.style.height = '3.5rem';
    // WARN: Not so sure about this, but it's the value in
    // the style sheet and it works.
    this.recipientsList.style.height = '3.5rem';
    this.recipientsList.style.overflowY = 'hidden';
